...
Places ingested or retrieved for a trip, and stops scheduled on the itinerary, MUST belong to the resolved country of the trip scope. Border-adjacent catalogs MUST NOT schedule foreign POIs. Unknown-country POIs near a border MUST be excluded rather than guessed into the trip.
